...
const SCREENS = [
  {
    ...
    description:
      "Sundown light, soft sand textures, and a screen tuned for the slow end of the day. Movie Time for two: complimentary dry snacks, juice, popcorn, and mineral water included.",
    details: [
      { label: "Theme", value: "Beach" },
      { label: "Couples", value: "From ₹999 / hour" },
      { label: "Extra guest", value: "₹300 / person" },
    ],
    photoKey: "screen-beach" as const,
    photoCaption: "The Beach Shack — sundown setting",
    href: "/book/beach",
  },
  {
    index: "02",
    ...
    description:
      "Romantic by design. Soft seating, fairy lights overhead, the kind of quiet most date nights don't manage. Movie Time for two with the complimentary hamper baked in.",
    details: [
      { label: "Theme", value: "Romantic" },
      { label: "Couples", value: "From ₹999 / hour" },
      { label: "Extra guest", value: "₹300 / person" },
    ],
    photoKey: "screen-grass" as const,
    photoCaption: "Love Den — anniversary setup",
    href: "/book/grass",
  },
  {
    index: "03",
    ...
    poeticName: "Jungle canopy, private jacuzzi.",
    description:
    ...
    photoCaption: "Nature Paradise — Celebration setup",
    href: "/book/forest",
  },
];
